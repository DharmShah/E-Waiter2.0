...
class OrderModel extends Model
{
    ...
    protected $allowedFields = ['itemname', 'quantity', 'tableno', 'served'];

    public function getOrdersWithPrice($tableno)
    {
        return $this->db->table('tableorder')
            ->select('tableorder.id, tableorder.tableno, tableorder.itemname, tableorder.quantity, tableorder.served, dishrate.itemprice')
